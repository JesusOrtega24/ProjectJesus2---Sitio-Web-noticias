...
<html>
<head>
	<title>CETis 67 - Convocatorias</title>
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, user-scalable=no, initial-scale=1.0, maximun-scale=1.0, minimum-scale=1.0">
	<link rel="stylesheet" type="text/css" href="css/EstilosANEC.css">
...
<section class="container">
	<aside>
		<img src="imagenes/imagen (3).jpg" width="100%"><br><br>
		<div class="titular">
			<hr font size=3 color="#424242" width="90%" style="margin: 10px 5%;"><br>
			<h2>Convocatorias y mas</h2>
		</div>
		<ul>
		<center>
		...
		<div class="soporte">
			...
			<form action="php/enviarcomentario.php" method="post">
	...
	<h2 class="encabezado">CONVOCATORIAS Y CONCURSOS</h2>
		<?php

			include('php/conexion.php');

			$res = $con->query ("SELECT * from Convocatorias ORDER BY id DESC");
			foreach ($res as $row) 
			{ 
		?>
			<article>
				...
				<section class="doc">
					...
					<div class="boton">
						<a href="documentos/<?php echo $row[4]?>" target='_blank' title="Click aqui para ver el documento">Ver Documento </a>
					</div>
					<div class="boton">
						<a href="documentos/<?php echo $row[4]?>" download="<?php echo $row[1]?>">Descargar Archivo</a>
					</div>
				</section>
				<h3>Descripción del documento</h3><br>
				<p><?php echo $row[2]?></p><br>
				<p>Fecha: <?php echo $row[3]?></p><br>
			</article>			
		<?php
			}
