...
<section class="container">
	<aside>
		<img src="imagenes/imagen (1).jpg" width="100%"><br><br>
		<div class="titular">
	...
	<h2 class="encabezado">EVENTOS</h2>
		
		<?php
			
			include('php/conexion.php');

			$res = $con->query ("SELECT * from eventos ORDER BY id DESC");
			foreach ($res as $row) 
			{ 
		?>
			<article>
