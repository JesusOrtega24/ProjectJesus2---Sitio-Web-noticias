...
<section class="container">
	<aside>
		<img src="imagenes/imagen (4).jpg" width="100%"><br><br>
		<div class="titular">
	...
	<h2 class="encabezado">NOTICIAS</h2>
		
		<?php
			
			include('php/conexion.php');

			$res = $con->query ("SELECT * from noticias ORDER BY id DESC");
			foreach ($res as $row) 
			{ 
		?>
			<article>
				...
				?>
						<img src="php/imagenesnoticias/<?php echo $row[3]?>">
				<?php 
					}else {
				...
				<p>Autor(es): <?php echo $row[4]?></p><br>
				<p>Fecha: <?php echo $row[5]?></p>
			</article>			
		<?php
			}
